...
pub use self::labels::{
    ...
    BreakGlassStateLabel, ClientSoftwareLabel, DirectoryLabel, FetchDrainPath, FetchDrainPathLabel,
    PartitionLabel, SaslMechanismLabel, SchemaRejectionLabel, ShareGroupLabel, TopicLabel,
};
