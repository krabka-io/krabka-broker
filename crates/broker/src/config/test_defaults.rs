...
use crate::{
    config::{
        ...
        DEFAULT_OBSERVER_LAG_BOUND, DEFAULT_OFFSETS_RETENTION,
        DEFAULT_OFFSETS_RETENTION_CHECK_INTERVAL, FreezeConfig, NodeRole, ReplicationRuntimeConfig,
        RlmmKind, feature_flags::test_feature_flags, shared_epoch_ms,
    },
...
impl BrokerConfig {
    ...
    pub fn for_tests(log_dir: PathBuf) -> Self {
        ...
        Self {
            ...
            offsets_retention: DEFAULT_OFFSETS_RETENTION,
            offsets_retention_check_interval: DEFAULT_OFFSETS_RETENTION_CHECK_INTERVAL,
