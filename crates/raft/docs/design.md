...
- **[KIP-630](https://cwiki.apache.org/confluence/display/KAFKA/KIP-630%3A+Kafka+Raft+Snapshot)** and **[KIP-1155](https://cwiki.apache.org/confluence/spaces/KAFKA/pages/347933361/KIP-1155+Metadata+Version+Downgrades)**. Checkpoints use Kafka's filename grammar and batch layout. A `metadata.version` downgrade is checkpointed at its exact boundary.
