...
export BENCH_DRIVER_IMAGE="${BENCH_DRIVER_IMAGE:-ghcr.io/krabka-io/krabka-bench-driver:custom}"
...
echo "  cargo run --release -p krabka-bench-driver --bin krabka-bench-report -- \\"
