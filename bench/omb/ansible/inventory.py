...
an inventory with three groups: `kafka`, `krabka`, `client`. Hosts
...
def build_inventory() -> dict:
    ...
    inv: dict = {
        "_meta": {"hostvars": {}},
        "all": {"children": ["kafka", "krabka", "client"]},
        "kafka": {"hosts": [], "vars": {}},
        "krabka": {"hosts": [], "vars": {}},
        "client": {"hosts": [], "vars": {}},
    }
    ...
    inv["krabka"]["vars"]["bootstrap_servers"] = outs["krabka_bootstrap_servers"]["value"]
