...
<!-- Generated by tools/generate-config-reference.py from docs/config-schema.json; do not edit by hand. -->
...
| `controller_election_timeout` | string | broker default | duration | Controller election timeout. Absent leaves the `BrokerConfig` default intact. |
